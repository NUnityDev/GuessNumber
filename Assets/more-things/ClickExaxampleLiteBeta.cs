...
public class ClickExaxampleLiteBeta : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        scoreText.text = ("won " + wins.ToString() + " games\nlost " + losses.ToString() + " games");

        // compare wins and losses
        if (wins < losses) {
            
            // change some text
            jobText.text = "You could do better!";
        }
        else if (wins == losses) {
            
            // change some text
            jobText.text = "Interesting!";
        }
        else if (wins > losses)
        {
            
            // change some text
            jobText.text = "Great job!";
        }
